...
fslmaths SIGMA_Anatomical_Brain_Atlas.nii -thr 71 -uthr 92 -bin hpc   -odt char

fslroi hpc L_hpc_mask 129 129    0 -1    0 -1
fslroi hpc R_hpc_mask 0   129    0 -1    0 -1
...
mkdir /media/amr/Amr_4TB/Dropbox/DTI_Review_Revisions/sigma/stress
mv /media/amr/Amr_4TB/Dropbox/DTI_Review_Revisions/sigma/*_mask.nii.gz /media/amr/Amr_4TB/Dropbox/DTI_Review_Revisions/sigma/stress


cd /media/amr/Amr_4TB/Dropbox/DTI_Review_Revisions/sigma/stress
fslmaths L_cc_mask -mul -0.333333333 L_cc_mask
fslmaths R_cc_mask -mul 1 R_cc_mask

fslmaths L_hpc_mask -mul 0.333333333 L_hpc_mask
